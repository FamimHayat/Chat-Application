...
const Nav = () => {
  return (
    <nav className="bg-primary pr-2 w-2xs ">
      <div className="flex flex-col h-dvh   rounded-r-4xl border-r-3 border-base signIn-shadow">
        ...
        <ul className="w-full mt-50 ">
          <li className="w-full">
            <Link
              to="/"
              className=" w-full  px-5 py-2 my-2 cursor-pointer hover:underline text-primary bg-brand hover:text-text hover:bg-secondary"
            >
